...
async def get_terms(
    ...
    """
    return service.get_terms(collection_id, page, page_size, is_enabled)
...
async def get_term(
    ...
    """
    return service.get_term_by_id(term_id)
...
async def create_term(
    ...
    """
    return service.create_term(collection_id, data)
...
async def update_term(
    ...
    """
    return service.update_term(collection_id, term_id, data)
...
async def delete_term(
    ...
    Returns:
        dict: 删除结果
    """
    service.delete_term(collection_id, term_id)
...
async def import_terms_from_csv(
    ...
    return service.import_from_csv(collection_id, csv_content)
...
async def export_terms_to_csv(
    ...
    Returns:
        Response: CSV文件响应
    """
    csv_content = service.export_to_csv(collection_id)
