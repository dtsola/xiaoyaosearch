...
> **最后更新**: 2026年04月12日
> **文档版本**: v2.6 - 并发控制优化版
> **核心特性**: 多模态AI智能搜索 + 专业术语库 + LLM增强 + 分块搜索 + 并发控制
> **技术栈**: BGE-M3 + FasterWhisper + Chinese-CLIP + Faiss + Whoosh + asyncio + Semaphore
> **性能指标**: 搜索精度95%、平均响应80-150ms、召回率提升60%、系统资源稳定
