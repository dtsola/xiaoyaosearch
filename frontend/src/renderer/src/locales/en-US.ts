...
export default {
  ...
  glossary: {
      ...
      uploadText: 'Click or drag a single CSV file to this area to upload',
      uploadHint: 'Only single CSV format file supported, max 5MB',
      ...
      settings: {
        ...
        noMatchingCollections: 'No matching collections found',
